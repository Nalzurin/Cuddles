    ...
    public static class CuddlesUtility
    {
        ...
        public static void AddictionPost(Pawn pawn)
        {
            ...
            if (addictionHediffDef.chemicalNeed != null)
            {
                ...
                {
                    float effect = 0.9f;
                    AddictionUtility.ModifyChemicalEffectForToleranceAndBodySize(pawn, DefOfs.Chem_Cuddles, ref effect, applyGeneToleranceFactor: false);
        ...
        public static void ApplyCuddlingHediffs(Pawn pawn, Pawn partner, float severity)
        {
            ...
            AddictionUtility.ModifyChemicalEffectForToleranceAndBodySize(pawn, DefOfs.Chem_Cuddles, ref effect, true, true);
